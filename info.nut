class ChooChoo extends AIInfo {
	...
	function GetVersion()     { return 361; }
	function GetDate()        { return "2010-06-12"; }
	function CreateInstance() { return "ChooChoo"; }
	function GetShortName()	  { return "CHOO"; }
	
	function GetSettings() {
	    AddSetting({name = "BootstrapLines", description = "Number of single track, point to point lines to start with", min_value = 0, max_value = 20, easy_value = 3, medium_value = 5, hard_value = 10, custom_value = 5, flags = AICONFIG_INGAME});
